...
public:
    enum class Code : char16_t {
        ...
        // For Chord symbol style editor
        JAZZ_MINOR_SCMI = 0xF3D7, // SC - Small Caps
        JAZZ_MINOR_MI= 0xF3D8,
        JAZZ_MINOR_M= 0xF3D9,
        JAZZ_MINOR_MIN= 0xF3DA,
        JAZZ_MINOR_MINUS= 0xF3DB,
        ...
        JAZZ_AUG_AUG= 0xF3E1,
        JAZZ_DIM_DIM= 0xF3E2,
        JAZZ_DIM_DEGREE= 0xF3E3,
        JAZZ_69_69SLASH= 0xF3E4,
        JAZZ_69_69STACKED= 0xF3E5,
        JAZZ_SUS_BASELINE= 0xF3E6,
        JAZZ_SUS_RAISED= 0xF3E7,
        JAZZ_OMIT_OMIT= 0xF3E8,
        JAZZ_OMIT_NO= 0xF3E9,
        JAZZ_STACKED_YES= 0xF3EA,
        JAZZ_STACKED_NO= 0xF3EB,

        SYMBOLS_BASS_TILTED= 0xF3EC,
        SYMBOLS_BASS_STACKED= 0xF3ED,
        SYMBOLS_BASS_BASELINE= 0xF3EE,
        SYMBOLS_MAJ7_TRIANGLE= 0xF3EF,
        SYMBOLS_MAJ7_STRIANGLE= 0xF3F0,
        SYMBOLS_MAJ7_STRIANGLE7= 0xF3F1,
        SYMBOLS_MAJ7_TRIANGLE7= 0xF3F2,
        SYMBOLS_AUG_PLUS= 0xF3F3,
        SYMBOLS_AUG_PLUS5= 0xF3F4,
        SYMBOLS_HDIM_SOSLASH7= 0xF3F5,
        SYMBOLS_HDIM_OSLASH7= 0xF3F6,
        SYMBOLS_DIM_SCIRCLE7= 0xF3F7,
        SYMBOLS_DIM_CIRCLE7= 0xF3F8,
        SYMBOLS_69_69SLASH= 0xF3F9,
        SYMBOLS_69_69STACKED= 0xF3FA,
        SYMBOLS_69_69FRACTION= 0xF3FB,
        SYMBOLS_OMIT_OMIT= 0xF3FC,
        SYMBOLS_OMIT_NO= 0xF3FD,
        SYMBOLS_STACKED_YES= 0xF3FE,
        SYMBOLS_STACKED_NO= 0xF3FF,

        POP_MINOR_M= 0xF400,
        POP_MINOR_MIN= 0xF401,
        POP_MAJ7_MAJ7= 0xF402,
        POP_MAJ7_MA7= 0xF403,
        POP_AUG_AUG= 0xF404,
        POP_AUG_PLUS= 0xF405,
        POP_AUG_PLUS5= 0xF406,
        POP_DIM_DIM= 0xF407,
        POP_DIM_DEGREE= 0xF408,
        POP_OMIT_OMIT= 0xF409,
        POP_OMIT_NO= 0xF40A,
        POP_STACKED_YES= 0xF40B,
        POP_STACKED_NO= 0xF40C,
